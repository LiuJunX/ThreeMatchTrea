...
namespace Match3.Unity.Views
{
    ...
    public static class TileAnimationHelper
    {
        ...
        public const float BounceEndTime = 0.15f;
        ...
        /// </returns>
        public static (float newBounceTime, float squashFactor) CalculateBounceSquash(float bounceTime, float dt)
        {
